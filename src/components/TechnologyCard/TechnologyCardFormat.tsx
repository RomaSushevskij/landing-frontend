...
export const TechnologyCardFormat = (): ReturnComponent => {
  return (
    <svg
      width="181"
      height="230"
    ...
    >
      <g filter="url(#filter0_b_477_71)">
        ...
        <path
          ...
          stroke="url(#paint0_linear_477_71)"
          strokeOpacity="0.7"
        />
      </g>
      <defs>
        ...
        >
          ...
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_477_71"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_backgroundBlur_477_71"
            result="shape"
          />
        </filter>
        <linearGradient
          id="paint0_linear_477_71"
          x1="161.09"
          y1="208.35"
          x2="14.5698"
          y2="-9.78639"
